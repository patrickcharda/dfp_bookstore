...
SECRET_KEY = "django-insecure-3ak4@l&6-$#-pvxbzs^c!l-@83=wnf!&8)v*lcih!=csocd#-8"
...
STATICFILES_STORAGE = "django.contrib.staticfiles.storage.StaticFilesStorage"  # on rend ici explicite ce qui est par défaut
